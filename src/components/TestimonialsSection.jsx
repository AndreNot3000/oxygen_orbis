...
const TESTIMONIAL_COLUMNS = [
  ...
  [
    ...
    },
    {
      ...
      message: "The chauffeur pickup from Moniya train station took just 10-15 minutes. The suite was spotless with calming views of the IITA forest.",
      country: "🇳🇬 Lagos, Nigeria",
  ...
  [
    ...
    },
    {
      ...
      room: "Executive Balcony Suite",
      message: "Visited family in Ibadan and stayed a full week here. The 10-15 minute chauffeur connection to Moniya rail terminal made transit effortless.",
